...
const Nav = () => {
    ...
    window.addEventListener("scroll", function () {
        ...
        // the scroll-header className to a tag with the header tag
                    ...
                    <ul className="nav__list grid">
                        ...
                        <li className="nav__item">
                            {/* <a href="/" className="nav__link active-link"> */}
                                <i className='bx bxs-book-bookmark nav__icon' ></i>
                        ...
                        <li className="nav__item">
                            {/* <a href="/Clothes" className="nav__link active-link"> */}
                                <i className='bx bx-male-female nav__icon' ></i>
                        ...
                        <li className="nav__item">
                            {/* <a href="/Shoeses" className="nav__link active-link"> */}
                                <i className='bx bxl-shopify nav__icon' ></i>
                        ...
                        <li className="nav__item">
                            {/* <a href="/Beauty&Care" className="nav__link active-link"> */}
                                <i className='bx bxs-laugh nav__icon' ></i>
                        ...
                        <li className="nav__item">
                            {/* <a href="/Toys" className="nav__link"> */}
                                <i className='bx bxs-balloon nav__icon' ></i>
                        ...
                        <li className="nav__item">
                            {/* <a href="/Watches" className="nav__link"> */}
                                <i className='bx bxs-watch nav__icon' ></i>
                        ...
                        <li className="nav__item">
                            {/* <a href="/Catalog" className="nav__link"> */}
                                <i className='bx bxs-hand-down nav__icon'></i>
